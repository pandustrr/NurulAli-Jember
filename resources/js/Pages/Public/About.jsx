            ...
            <main className="pt-24 pb-16">
                ...
                <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 mt-24">
                    <div className="text-center mb-16">
                        ...
                        <div className="mt-8 p-10 bg-slate-50 rounded-[3rem] border border-slate-100">
                    ...
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-start mt-20">
                        ...
                        <div className="relative">
                            <div className="aspect-[4/5] rounded-[4rem] overflow-hidden shadow-2xl shadow-emerald-900/20 border-8 border-white">
                                <img
                            ...
                            <div className="absolute -bottom-8 -left-8 bg-white p-8 rounded-[2.5rem] shadow-xl border border-slate-50 max-w-xs">
