...
import { CheckCircleIcon, BanknotesIcon, BuildingLibraryIcon } from '@heroicons/react/24/outline';
                                    ...
                                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                        ...
                                        <div className="space-y-2 md:col-span-2">
                                            ...
                                            <textarea
                                                ...
                                                className="w-full px-5 py-4 rounded-lg bg-slate-50 border border-slate-100 focus:ring-2 focus:ring-emerald-500 focus:bg-white transition-all outline-none h-28"
