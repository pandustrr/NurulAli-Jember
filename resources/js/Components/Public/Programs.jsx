            ...
            <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    {lembagas.map((program, index) => {
                        ...
                        return (
                            <div
                                ...
                                className="group relative bg-white p-10 rounded-[3rem] border border-slate-100 transition-all duration-500 hover:shadow-2xl hover:shadow-emerald-900/10 hover:-translate-y-3 cursor-pointer"
                            >
                                ...
                                <div className={`${style.color} w-16 h-16 rounded-3xl flex items-center justify-center mb-8 shadow-sm group-hover:scale-110 group-hover:rotate-3 transition-all duration-500 text-2xl`}>
                ...
                {selectedLembaga && (
                    <div className="fixed inset-0 z-[100] flex items-center justify-center p-4 bg-slate-950/60 backdrop-blur-md animate-in fade-in duration-300">
                        <div
                            className="bg-white w-full max-w-4xl rounded-[3rem] overflow-hidden shadow-2xl animate-in zoom-in slide-in-from-bottom-10 duration-500 relative max-h-[90vh] flex flex-col md:flex-row"
                        >
                            {/* Close Button Moble */}
                            <button
                            ...
                            <div className="w-full md:w-1/2 p-8 md:p-12 overflow-y-auto">
                                ...
                                <div className="space-y-6">
                                    ...
                                    <div className="pt-8 flex flex-col gap-4">
                                        <a href="/kontak" className="w-full py-4 bg-emerald-600 text-white text-center font-black rounded-2xl hover:bg-emerald-700 transition-all shadow-xl shadow-emerald-200 uppercase tracking-widest text-sm">
                                            Tanya Admin
                                        </a>
                                        <button
                                            onClick={() => setSelectedLembaga(null)}
                                            className="w-full py-4 border-2 border-slate-100 text-slate-400 font-bold rounded-2xl hover:bg-slate-50 transition-all text-sm uppercase tracking-widest"
                                        >
                                            Tutup
                                        </button>
                                    </div>
