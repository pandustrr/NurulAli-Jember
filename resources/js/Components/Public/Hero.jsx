        ...
        <section id="beranda" className="relative h-screen min-h-[700px] flex items-center justify-center overflow-hidden">
            ...
            <div className="relative z-10 text-center px-4 max-w-5xl mx-auto">
                ...
                <div className="flex flex-col sm:flex-row items-center justify-center gap-6 mt-12">
                    <a href="/pendaftaran" className="bg-emerald-600 hover:bg-emerald-700 text-white px-10 py-4 rounded-full font-bold transition-all transform hover:-translate-y-1 hover:shadow-2xl shadow-emerald-900/40 flex items-center gap-3 group active:scale-95">
                        Daftar Sekarang
                    ...
                    <a href="/about" className="border-2 border-white/30 hover:border-white/90 text-white px-10 py-4 rounded-full font-bold transition-all backdrop-blur-md hover:bg-white/10 active:scale-95">
                        Lihat Profil
                    </a>
                </div>
            </div>
