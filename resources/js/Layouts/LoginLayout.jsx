            ...
            <div className="relative z-10 w-full max-w-md px-6 animate-fade-in">
                <div className="text-center mb-10">
                    <Link href="/" className="inline-flex flex-col items-center gap-4 group">
                        <div className="bg-emerald-600 w-20 h-20 rounded-2xl flex items-center justify-center text-white font-bold text-4xl shadow-2xl shadow-emerald-900/40 group-hover:scale-110 transition-transform duration-500">
                            ن
                        </div>
                        <div>
                ...
                <div className="w-full bg-white/95 backdrop-blur-xl px-10 py-12 shadow-2xl rounded-2xl border border-white/20">
                    {children}
                </div>
