    ...
    public function run(): void
    {
        $lembagas = [
            [
                ...
                'admin_name' => 'Ustadz Ahmad Fauzi',
                'username' => 'admin_tahfidz',
                'email' => 'tahfidz@nurulali.sch.id',
            ...
            [
                ...
                'admin_name' => 'Ustadz Slamet Riyadi',
                'username' => 'admin_mts',
                'email' => 'mts@nurulali.sch.id',
                'password' => bcrypt('password'),
            ...
            [
                ...
                'admin_name' => 'Ustadzah Nurul Hidayah',
                'username' => 'admin_ma',
                'email' => 'ma@nurulali.sch.id',
                'password' => bcrypt('password'),
            ...
            [
                ...
                'admin_name' => 'Ustadz Junaidi',
                'username' => 'admin_bahasa',
                'email' => 'bahasa@nurulali.sch.id',
                'password' => bcrypt('password'),
            ...
            [
                ...
                'admin_name' => 'Kiai Haji Musthofa',
                'username' => 'admin_agama',
                'email' => 'agama@nurulali.sch.id',
                'password' => bcrypt('password'),
            ...
            [
                ...
                'admin_name' => 'Zaidan (Ketua OSIS)',
                'username' => 'admin_osis',
                'email' => 'osis@nurulali.sch.id',
                'password' => bcrypt('password'),
        ...
        foreach ($lembagas as $lembaga) {
            Lembaga::updateOrCreate(['username' => $lembaga['username']], $lembaga);
        }
    }
}
